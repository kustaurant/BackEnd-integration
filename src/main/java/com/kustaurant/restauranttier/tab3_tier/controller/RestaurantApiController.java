...
public class RestaurantApiController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "restaurant found", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = RestaurantDetailDTO.class))}),
    ...
    // 리뷰 추천하기
    @PostMapping("/{restaurantId}/comment/{commentId}/like")
    ...
    // 리뷰 비추천하기
    @PostMapping("/{restaurantId}/comment/{commentId}/dislike")
    ...
    // 식당 대댓글 달기
    @PostMapping("/{restaurantId}/comment/{commentId}")
