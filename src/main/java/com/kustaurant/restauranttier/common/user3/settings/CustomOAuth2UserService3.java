//package com.kustaurant.restauranttier.common.user3.settings;
//
...
//public class CustomOAuth2UserService3 implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
//
...
//
//        // 클라이언트 등록 ID(naver, kakao, apple)와 사용자 이름 속성을 가져온다.
...
//        // 이메일로 가입된 회원인지 조회한다.
//        Optional<Member> findMember = userService.findByEmail(email);
//
