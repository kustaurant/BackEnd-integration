...
//
//import com.kustaurant.restauranttier.common.user3.settings.JwtUtil;
...
//        Optional<RefreshToken3> refreshToken = tokenRepository.findByAccessToken(accessToken);
//
//        // RefreshToken이 존재하고 유효하다면 실행
//        if (refreshToken.isPresent() && jwtUtil.verifyToken(refreshToken.get().getRefreshToken())) {
//            // RefreshToken 객체를 꺼내온다.
//            RefreshToken3 resultToken = refreshToken.get();
