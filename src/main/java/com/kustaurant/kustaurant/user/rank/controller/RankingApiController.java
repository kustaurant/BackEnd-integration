...
public class RankingApiController {
    ...
    // 1. 커뮤니티 메인 유저랭킹
    @GetMapping("/api/v2/community/ranking")
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공", content = {@Content(array = @ArraySchema(schema = @Schema(implementation = UserRank.class)))})
    public List<UserRank> ranking(
