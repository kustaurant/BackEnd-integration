...
import com.kustaurant.kustaurant.post.post.controller.response.LikeOrDislikeDTO;
...
public class PostUserReactionApiController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "게시글 좋아요 처리가 완료되었습니다", content = @Content(schema = @Schema(implementation = LikeOrDislikeDTO.class))),
