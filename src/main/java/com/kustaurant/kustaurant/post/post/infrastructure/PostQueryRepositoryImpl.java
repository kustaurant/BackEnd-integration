...
public class PostQueryRepositoryImpl implements PostQueryRepository {
    ...
    @Override
    public Page<PostDTOProjection> findPostsByCategoryWithAllData(
    ...
    @Override
    public Page<PostDTOProjection> findPopularPostsByCategoryWithAllData(
            PostCategory category,
            Pageable pageable,
            Long currentUserId,
            int minLikeCount
    ...
    // 검색 키워드로 게시글 목록 조회
    @Override
    public Page<PostDTOProjection> findPostsBySearchKeywordWithAllData(
    ...
    @Override
    public Page<PostDTOProjection> findPopularPostsBySearchKeywordWithAllData(
