...
public interface PostQueryRepository {
     ...
     * @return Page<PostDTOProjection>
     */
    Page<PostDTOProjection> findPostsByCategoryWithAllData(PostCategory category, Pageable pageable, Long currentUserId);
     ...
     * @return Page<PostDTOProjection>
     */
    Page<PostDTOProjection> findPopularPostsByCategoryWithAllData(PostCategory category, Pageable pageable, Long currentUserId, int minLikeCount);
     ...
     * @return Page<PostDTOProjection>
     */
    Page<PostDTOProjection> findPostsBySearchKeywordWithAllData(String keyword, PostCategory category, Pageable pageable, Long currentUserId);
     ...
     * @return Page<PostDTOProjection>
     */
    Page<PostDTOProjection> findPopularPostsBySearchKeywordWithAllData(String keyword, PostCategory category, Pageable pageable, Long currentUserId, int minLikeCount);
}