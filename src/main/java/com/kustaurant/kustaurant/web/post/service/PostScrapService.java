...
public class PostScrapService {
    ...
    public Map<String, Object> scrapCreateOfDelete(PostEntity postEntity, UserEntity UserEntity){
        List<PostScrap> postScrapList = postEntity.getPostScrapList();
        List<PostScrap> userScrapList = UserEntity.getScrapList();
        Optional<PostScrap> scrapOptional = postScrapRepository.findByUserAndPostEntity(UserEntity, postEntity);
