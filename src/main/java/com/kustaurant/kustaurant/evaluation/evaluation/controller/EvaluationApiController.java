...
public class EvaluationApiController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "평가하기 후에 식당 정보를 다시 반환해줍니다.", content = {@Content(array = @ArraySchema(schema = @Schema(implementation = EvalCommentResponse.class)))}),
