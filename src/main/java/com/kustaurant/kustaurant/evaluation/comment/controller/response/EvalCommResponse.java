...
public record EvalCommResponse(
        ...
        List<EvalCommResponse> commentReplies
) {
        /** 대댓글을 셋팅한 ‘새 DTO’ 반환 */
        public EvalCommResponse withCommentReplies(List<EvalCommResponse> replies) {
...
//    public static EvalCommResponse convertCommentWhenEvaluation(
...
//    }
//
//    public static EvalCommResponse convertCommentWhenSubComment(
...
//    public static EvalCommResponse convertCommentWhenLikeDislike(RestaurantCommentEntity comment, Long userId) {
//        return new EvalCommResponse(
...
//        );
//    }
//    public static EvalCommResponse convertCommentWhenLikeDislike(EvaluationEntity evaluation, Long userId) {
//        return new EvalCommResponse(
//                null, null, null, null, null, null, null,
//                isUserLikeDisLikeStatus(evaluation, userId),
//                evaluation.getRestaurantCommentLikeList().size(),
