package com.kustaurant.mainapp.v1.user;
...
import com.kustaurant.mainapp.global.auth.jwt.JwtUtil;
import com.kustaurant.mainapp.user.login.api.controller.LoginRequest;
import com.kustaurant.mainapp.user.login.api.controller.response.TokenResponse;
import com.kustaurant.mainapp.user.login.api.domain.LoginApi;
import com.kustaurant.mainapp.user.login.api.service.LoginService;
import com.kustaurant.mainapp.user.login.api.service.TokenService;
import com.kustaurant.mainapp.v1.common.ErrorResponse;
import com.kustaurant.mainapp.v1.user.dto.AppleLoginRequest;
import com.kustaurant.mainapp.v1.user.dto.NaverLoginRequest;
import com.kustaurant.mainapp.v1.user.dto.V1TokenResponse;
