package com.kustaurant.mainapp.user.rank.service;
...
import com.kustaurant.mainapp.user.rank.domain.SeasonRange;
import com.kustaurant.mainapp.user.rank.infrastructure.RankingRepository;
