package com.kustaurant.mainapp.restaurant.query.common.dto;

import com.kustaurant.mainapp.restaurant.restaurant.constants.MapConstants;
import com.kustaurant.mainapp.restaurant.restaurant.constants.Coordinate;
...
public class RestaurantTierMapDTO {
    ...
    List<RestaurantCoreInfoDto> favoriteRestaurants = new ArrayList<>();
    @Schema(description = "티어가 있는 식당 리스트입니다. 이 리스트의 식당은 지도에 항상 표시됩니다.")
    List<RestaurantCoreInfoDto> tieredRestaurants = new ArrayList<>();
    ...
    public static class ZoomAndRestaurants {
        ...
        private List<RestaurantCoreInfoDto> restaurants;
    }

    public void insertZoomAndRestaurants(Integer zoom, List<RestaurantCoreInfoDto> restaurants) {
