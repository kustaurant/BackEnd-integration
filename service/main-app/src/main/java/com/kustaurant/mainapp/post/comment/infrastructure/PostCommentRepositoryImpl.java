...
import static com.kustaurant.mainapp.global.exception.ErrorCode.COMMENT_NOT_FOUND;

import com.kustaurant.mainapp.post.comment.domain.PostComment;
import com.kustaurant.mainapp.post.comment.infrastructure.entity.PostCommentEntity;
import com.kustaurant.mainapp.post.comment.infrastructure.jpa.PostCommentJpaRepository;
import com.kustaurant.mainapp.post.comment.service.port.PostCommentRepository;
