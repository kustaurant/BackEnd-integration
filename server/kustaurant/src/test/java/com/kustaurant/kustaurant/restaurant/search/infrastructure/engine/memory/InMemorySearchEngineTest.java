...
class InMemorySearchEngineTest {
    ...
    void shouldReturnEmptyResultWhenKeywordsAreNullOrEmpty() {
        SearchResult nullResult = searchEngine.searchRestaurantIds(null, PageRequest.of(1, 10));
        SearchResult emptyResult = searchEngine.searchRestaurantIds(new String[0], PageRequest.of(1, 10));
    ...
    void shouldReturnExactHighlightRangesForTitleAndCategory() {
        SearchResult result = searchEngine.searchRestaurantIds(new String[]{"korean"}, PageRequest.of(1, 10));
    ...
    void shouldNormalizeCaseAndPunctuationInQuery() {
        SearchResult result = searchEngine.searchRestaurantIds(new String[]{"K-BBQ!!!"}, PageRequest.of(1, 10));
    ...
    void shouldReturnOnlyRequestedPageSizeWhenResultsExceedPageSize() {
        SearchResult result = searchEngine.searchRestaurantIds(new String[]{"korean"}, PageRequest.of(1, 1));
    ...
    void shouldFindBySubstringAndReturnDistinctOriginalMenuNames() {
        SearchResult result = searchEngine.searchRestaurantIds(new String[]{"bibim"}, PageRequest.of(1, 10));
