...
@RequestMapping("/api")
@Tag(name = "community-user-ranking-controller")
public class RankingApiController {
    ...
    @Operation(summary = "커뮤니티 메인의 랭킹 탭에서 유저 랭킹 리스트 조회",
            description = "평가 수 기반의 유저 랭킹을 반환. 시즌별(해당년도 상반기,하반기), 누적순(전체 데이터 누적)으로 랭킹을 조회 가능. 평가를 1개 이상 한 유저들로 최대100명 랭킹이 매겨집니다.")
