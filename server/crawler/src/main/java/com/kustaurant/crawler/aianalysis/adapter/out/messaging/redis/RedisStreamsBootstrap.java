...
public class RedisStreamsBootstrap implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        redisStreamsUtils.createStreamAndGroupIfNotExists(streamsProps.aiAnalysisCrawling(), streamsProps.group());
        redisStreamsUtils.createStreamAndGroupIfNotExists(streamsProps.aiAnalysisReview(), streamsProps.group());
